...
tweetHodor();
// ...and then every 6 mins after that. Time here is in milliseconds, so
// 1000 ms = 1 second, 1 sec * 60 = 1 min, 1 min * 6 = 6 minutes --> 1000 * 60 * 6
// setInterval(tweetHodor, 1000 * 60 * 60);
